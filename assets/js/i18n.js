...
const I18N = {
  en: {
    ...
    about: {
      ...
      text2: "I hold AWS Solutions Architect Associate, Certified Kubernetes Administrator (CKA) and HashiCorp Terraform Associate certifications, and I have hands-on experience supporting compliance programs aligned with GDPR, PCI DSS, ISO 27001 and SOC 2 — a strong fit for regulated industries across Europe and the Gulf.",
      text3: "A native Arabic speaker, fluent in French and English, I'm open to relocation and available on a 30-day notice period — ready to bring reliable, secure and cost-conscious platform engineering to your team.",
      value1: { title: "EU & GCC ready", text: "Trilingual (AR/FR/EN), open to relocation, comfortable working across European and Gulf enterprise environments." },
    ...
    contact: {
      ...
      sub: "Open to DevOps, Platform & Cloud/SRE roles across the EU and the Gulf region — full-time or contract.",
      email: "Email",
      phone: "Phone",
      location: "Location",
  ...
  fr: {
    ...
    hero: {
      ...
      badge: {
        location: "Tunis, Tunisie · Ouvert à la relocalisation",
        notice: "Préavis : 30 jours",
    ...
    about: {
      ...
      text2: "Je suis certifié AWS Solutions Architect Associate, Certified Kubernetes Administrator (CKA) et HashiCorp Terraform Associate, et j'ai une expérience concrète des programmes de conformité RGPD, PCI DSS, ISO 27001 et SOC 2 — un atout pour les secteurs régulés en Europe et dans le Golfe.",
      text3: "Arabophone natif, courant en français et en anglais, je suis ouvert à la relocalisation avec un préavis de 30 jours — prêt à apporter une ingénierie de plateforme fiable, sécurisée et maîtrisée en coûts à votre équipe.",
      value1: { title: "Prêt pour l'UE & le Golfe", text: "Trilingue (AR/FR/EN), ouvert à la relocalisation, à l'aise dans des environnements d'entreprise européens et du Golfe." },
    ...
    contact: {
      ...
      sub: "Ouvert aux postes DevOps, Plateforme & Cloud/SRE en Europe et dans la région du Golfe — CDI ou mission.",
      email: "Email",
      phone: "Téléphone",
